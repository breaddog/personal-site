...
export const PortfolioManager: React.FC<PortfolioManagerProps> = ({
  ...
  const cloudEffect = (reference: number, duration: number) => {
    ...
    looper.forEach((el: any) => {
      ...
      randScale = 0.4 > randScale ? randomValue(0.05, 1, true) : randScale
        ...
        <div className={classNames(sectionStyles.container, styles.container)}>
          ...
          <div className={styles.body}>
            <div className={styles.sky}>
              <div
                id='cloud-container-0'
                className={styles.clouds}
              >
                {map([...Array(N_CLOUDS).keys()], (el: any, idx: number) => {
                  return (
                    <Cloud
                      className={classNames('portfolio__cloud-0', styles.cloud)}
                      key={idx}
                    />
                  )
                })}
              ...
              >
                {map([...Array(N_CLOUDS).keys()], (el: any, idx: number) => {
                  return (
                    <Cloud
                      className={classNames('portfolio__cloud-1', styles.cloud)}
                      key={idx}
                    />
                  )
                })}
              ...
              >
                {map([...Array(N_CLOUDS).keys()], (el: any, idx: number) => {
                  return (
                    <Cloud
                      className={classNames('portfolio__cloud-2', styles.cloud)}
                      key={idx}
                    />
                  )
                })}
            ...
            <div className={styles.overlay}>
              ...
              >
                ...
                <div className={classNames('modal__body', styles.box__body)}>
                  ...
                  <p className={styles.text}>
                    I am in the end a developer by heart and seek to take
                    inspiration from all to contribute towards a cohesive team
                    in the end.
                  </p>
